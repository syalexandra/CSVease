...
case $choice in
    1)
        ...
        python3 /app/CSVeaseOptimizer.py DeadCodeElimination.ease DeadCodeElimination
        ;;
    2)
        echo "Running Constant Propagation..."
        python3 /app/CSVeaseOptimizer.py ConstantPropogation.ease ConstantPropagation
        ;;
    3)
        echo "Running Constant Folding..."
        python3 /app/CSVeaseOptimizer.py ConstantFolding.ease ConstantFolding
        ;;
    4)
        echo "Running Common SubExpression Elimination..."
        python3 /app/CSVeaseOptimizer.py CommonSubExpressionElimination.ease CommonSubExpressionElimination
        ;;
    *)
